...
public class MainMenuScene extends MenuScene implements
  ...
  public MainMenuScene() {
    ...
    IMenuItem startButton = new TextMenuItem(MENU_START,
        activity.mFont, activity.getString(R.string.start),
        activity.getVertexBufferObjectManager());
    startButton.setPosition((mCamera.getWidth() - startButton.getWidth()) / 2,
        (mCamera.getHeight() - startButton.getHeight()) / 2);
